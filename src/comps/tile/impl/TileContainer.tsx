...
export const TileContainer = (props: { children: ReactElement | ReactElement[]; type: TileBackground }) => {
    ...
    const startedCss =
        'relative flex justify-center border-slate-500/80 border-4 border-solid items-center m-2 min-w-[40rem] h-[20rem] text-center rounded-2xl bg-gradient-to-t text-white dark:text-black font-bold transition-all scale-1';
    const stoppedCss =
        'relative flex justify-center border-slate-500/0  border-4 border-solid items-center m-2 min-w-[40rem] h-[20rem] text-center rounded-2xl bg-gradient-to-t text-white dark:text-black font-bold transition-all scale-0';
